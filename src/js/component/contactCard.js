...
export const ContactCard = ({ contact }) => {
    return (
        <div className="d-flex justify-content-between mx-5 border border-black py-3 px-3">
            ...
            <div className="d-flex">
                <img src="https://cdn-icons-png.flaticon.com/512/78/78422.png" alt="pencil_icon" height="20px" width="20px" className="me-4" />
                <img src="https://static.vecteezy.com/system/resources/previews/000/630/479/non_2x/vector-trash-can-icon-symbol-illustration.jpg" alt="trash_icon" height="20px" width="20px" />
            </div>
        </div>
    );
};
